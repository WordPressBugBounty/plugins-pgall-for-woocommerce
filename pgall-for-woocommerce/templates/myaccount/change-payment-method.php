...
<tr>
    ...
    <td class="pafw-payment-method">
        <input type="button" class="button pafw-show-payment-method-selector" value="<?php esc_attr_e( "결제수단 변경", "pgall-for-woocommerce" ); ?>">
        <div class="pafw-payment-method-selector-wrapper" style="display: none;">
            ...
            <input type="button" class="button pafw-change-payment-method" value="<?php esc_attr_e( "변경하기", "pgall-for-woocommerce" ); ?>">
        </div>
    </td>
</tr>