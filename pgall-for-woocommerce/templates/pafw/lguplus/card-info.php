...
<div class="pafw-card pafw-<?php echo esc_attr( $master_id ); ?>">
    ...
    <div class="pafw_card_form" style="display: none;">
        <form>
            ...
            <div class="lguplus-register-card pafw-register-custom-handler" data-payment_method="<?php echo esc_attr( $payment_gateway->id ); ?>"><?php esc_html_e( "등록하기", "pgall-for-woocommerce" ); ?></div>
        </form>
    </div>
</div>
