...
<?php else: ?>
    <p><?php esc_html_e( '구매하신 상품이 배송되었습니다. 상품 수령 후 구매 확인을 해주세요.', 'pgall-for-woocommerce' ); ?></p>
    <div class="pafw-escrow">
        <input type="button" class="button" id="pafw-escrow-purchase-decide" value="<?php esc_html_e( '구매 확인', 'pgall-for-woocommerce' ); ?>"/>
    </div>
<?php endif; ?>
