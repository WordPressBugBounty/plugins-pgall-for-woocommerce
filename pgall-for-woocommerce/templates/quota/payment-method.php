...
<?php if ( 'yes' == pafw_get( $payment_gateway->settings, 'enable_quota', 'no' ) ) : ?>
    <div class="pafw-card-info">
        <div class="fields-wrap">
            <select name="pafw_<?php esc_attr_e( $payment_gateway->get_master_id() ); ?>_card_quota">
...
<?php else: ?>
    <input type="hidden" name="pafw_<?php esc_attr_e( $payment_gateway->get_master_id() ); ?>_card_quota" value="00">
<?php endif; ?>