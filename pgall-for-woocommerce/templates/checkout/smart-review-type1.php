    ...
    <div class="pafw-review">
		<?php foreach ( $rate_options as $rate_option ) : ?>
            <div class="pafw-smart-reivew-item">
                ...
                <label style="background-image: url('<?php echo esc_url( PAFW()->plugin_url() . '/assets/images/rating/face/' . $rate_option[ 'rate' ] . '.png' ); ?>')" for="pafw_smart_review_rate<?php echo esc_attr( $rate_option[ 'rate' ] ); ?>">
