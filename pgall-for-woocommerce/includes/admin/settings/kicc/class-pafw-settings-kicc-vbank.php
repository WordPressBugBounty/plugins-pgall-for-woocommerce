				...
				array(
					...
					'elements' => array(
						...
						array(
							...
							'readonly'  => 'yes',
							'default'   => '',
							'desc2'     => '<code>' . untrailingslashit( WC()->api_request_url( 'WC_Gateway_Kicc_VBank?type=vbank_noti', pafw_check_ssl() ) ) . '</code>' . __( '<div class="desc2">가상계좌 무통장입금 내역 통보에 사용되는 URL 주소입니다.<br>가상계좌 무통장입금 매뉴얼을 참고하여 KICC 가맹점 관리자 페이지에 접속하여 주소를 입력하여 주시기 바랍니다.</div>', 'pgall-for-woocommerce' ),  // phpcs:ignore WordPress.WP.I18n.NoHtmlWrappedStrings
						),
						array(
