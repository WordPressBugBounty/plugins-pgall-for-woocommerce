...
class WC_Gateway_PAFW extends WC_Payment_Gateway { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
	...
	public static function update_settings() {
		...
		$_REQUEST = array_merge( $_REQUEST, json_decode( pafw_get_unslash( $_REQUEST, 'values' ), true ) );
	...
	function admin_options() {
		...
		wc_back_link( __( 'Return to payments', 'pgall-for-woocommerce' ), admin_url( 'admin.php?page=wc-settings&tab=checkout' ) );
		echo '</h2>';
