...
if ( class_exists( 'WC_Payment_Gateway' ) ) {
	...
	if ( ! class_exists( 'WC_Gateway_TossPayments_Applepay' ) ) {
		...
		class WC_Gateway_TossPayments_Applepay extends WC_Gateway_TossPayments { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
